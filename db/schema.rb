...
ActiveRecord::Schema.define(version: 20170515102424) do
  ...
  add_index "phones", ["manufacturer_id"], name: "fk_phones_manufacturers", using: :btree
  ...
  add_index "phones_suppliers", ["phone_id"], name: "fk_phones_suppliers_phones", using: :btree
  add_index "phones_suppliers", ["supplier_id"], name: "fk_phones_suppliers_suppliers", using: :btree
  ...
  add_foreign_key "phones", "manufacturers", name: "fk_phones_manufacturers", on_delete: :cascade
  add_foreign_key "phones_suppliers", "phones", name: "fk_phones_suppliers_phones", on_delete: :cascade
  add_foreign_key "phones_suppliers", "suppliers", name: "fk_phones_suppliers_suppliers", on_delete: :cascade
end
